...
describe('Content Management Component', () => {
  ...
  beforeEach(() => {
    ...
    jest
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '2c45dd30-cc68-4449-8234-3960f9956c9b' }],
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '4dd1e232-4125-4f33-9d38-5c4e65096fc6' }],
            headers: new HttpHeaders({
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.contents()[0]).toEqual(expect.objectContaining({ id: '2c45dd30-cc68-4449-8234-3960f9956c9b' }));
  });
