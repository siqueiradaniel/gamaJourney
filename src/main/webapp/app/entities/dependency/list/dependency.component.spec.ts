...
import { sampleWithRequiredData } from '../dependency.test-samples';
...
describe('Dependency Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.dependencies()[0]).toEqual(expect.objectContaining({ id: 6675 }));
  });

  describe('trackId', () => {
    it('Should forward to dependencyService', () => {
      const entity = { id: 6675 };
      jest.spyOn(service, 'getDependencyIdentifier');
      const id = comp.trackId(entity);
      expect(service.getDependencyIdentifier).toHaveBeenCalledWith(entity);
