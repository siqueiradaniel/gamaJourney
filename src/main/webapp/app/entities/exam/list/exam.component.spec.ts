...
describe('Exam Management Component', () => {
  ...
  beforeEach(() => {
    ...
    jest
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '76c575c0-4181-4bc3-8fd5-1f26faadec72' }],
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '8fd7d5d8-491d-47df-ae8c-fc7fc485a98d' }],
            headers: new HttpHeaders({
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.exams()[0]).toEqual(expect.objectContaining({ id: '76c575c0-4181-4bc3-8fd5-1f26faadec72' }));
  });
