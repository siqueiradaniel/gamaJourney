...
describe('Student Management Component', () => {
  ...
  beforeEach(() => {
    ...
    jest
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '4b4bd123-76cd-4436-82e0-2256af75949b' }],
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '7367340f-f03a-4f57-be07-9afaafff3e9c' }],
            headers: new HttpHeaders({
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.students()[0]).toEqual(expect.objectContaining({ id: '4b4bd123-76cd-4436-82e0-2256af75949b' }));
  });
