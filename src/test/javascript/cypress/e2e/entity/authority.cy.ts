...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '84f4d14f-06d0-4673-818f-52c0e8d709af' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('309b84e8-966b-40f7-aab2-5434be14b0bc');
      cy.get(`[data-cy="name"]`).should('have.value', '309b84e8-966b-40f7-aab2-5434be14b0bc');
